...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-8 d-flex justify-content-end align-items-center">
          ...
          <div class="d-flex">
            <a class="" href="../login/login.php" style="color:black"><button type="button" class="btn btn-outline-dark me-2">Login</button></a>
            <a class="" href="../register/signup.php" style="color:black"><button type="button" class="btn btn-outline-dark me-2">Register</button></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="description">
    <div class="banner-home2 wow fadeInUp" data-wow-delay="100ms" style="background-image: url(../img/banner-block1_1.webp); height: 40vh;
